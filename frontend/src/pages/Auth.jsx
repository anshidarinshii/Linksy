  ...
  return (
    ...
    >
      ...
      {state === "register" && (
        <div className="w-full">
          ...
          <input
            ...
            className="border border-gray-200 rounded w-full p-2 mt-1 outline-purple-600"
            type="text"
            required
          />
        </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="bg-purple-600 hover:bg-purple-900 transition-all text-white w-full py-2 rounded-md cursor-pointer disabled:opacity-50"
      >
        {loading
          ? "Please wait..."
          : state === "register"
